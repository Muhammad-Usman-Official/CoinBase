    ...
    login(loginCredentials)
      ...
      .catch((err: AxiosError) => {
        if (err.status === 400) {
          ...
          setLoading(false);
          setError(err.message + " failed to loign! Maybe the server is down!");
        }
      });
  };
        ...
        <div className="container flex flex-col-reverse items-center justify-center h-screen mx-auto lg:flex-row">
          <div className="lg:w-2/5 w-[90vw] lg:translate-y-0 md:-translate-y-32 -translate-y-12 z-[2] px-8 lg:bg-[#94B0B7]/10 bg-[#2d283f]/60 max-w-lg backdrop-blur-sm py-7 rounded-xl">
            ...
            <form
              ...
              className="flex flex-col justify-center space-y-7 selection:bg-teal-300 h-ful"
              action=""
            >
              <div className="grid max-w-sm pl-5 gap-y-4 lg:pl-0">
                <div className="flex flex-col self-start w-full mx-auto mt-1 space-y-4 text-gray-800">
                  <label className="text-[#DDDDDA]" htmlFor="email">
                    Email Address
                  </label>
                  <TextInput
                    id={"email"}
                    ...
                    } w-full px-2 py-1 text-gray-800 rounded-md outline-none `}
                    type="email"
                  />
                </div>
                <div className="flex flex-col self-start w-full mt-1 space-y-2 text-gray-800">
                  <label className="text-[#DDDDDA]" htmlFor="password">
                    Password
                  </label>
                  <TextInput
                    className={`w-full px-2 py-1 text-gray-800 rounded-md outline-none ${
                      errors.password
                        ? "ring-red-700 ring"
                        : "ring-emerald-300 focus:ring"
                    }`}
                  ...
                  <button
                    ...
                    className={`${
                      errors.email || errors.password
                        ? "cursor-not-allowed hover:bg-[#10642f]"
                        : "cursor-pointer hover:bg-[#0b943d]"
                    } w-full flex outline-none lg:pl-0 pl-5 border-none focus:ring-violet-500 justify-center transition-colors max-w-sm ease-out delay-100 px-3 py-2 hover: ring-1 ring-slate-500 bg-[#10642f] text-white rounded-md`}
                    type="submit"
                  >
                    Login
                    {loading ? (
          ...
          <div className="lg:max-h-[80vh] max-lg:overflow-hidden h-[40%] w-full lg:top-0 lg:bottom-0 absolute bottom-0 lg:static flex lg:animate-pulse items-center justify-center">
            ...
            >
              <path
                id="b10fb2cf-c586-4c5f-9fbf-e678f5ffa3db-323"
                data-name="Path 133"
              ...
              />
              <path
                id="a32c10c7-75df-4179-a648-6a8d2a687209-324"
                data-name="Path 134"
              ...
              <path
                ...
                fill="#581ac9"
              />
              <circle cx="131.82814" cy="239.22404" r="51" fill="#581ac9" />
              <path
